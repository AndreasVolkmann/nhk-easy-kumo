...
import me.avo.kumo.util.PropertyReader
import me.avo.kumo.util.getLogger
import java.nio.charset.Charset

object LingqApi {

    val url = "https://www.me.avo.kumo.lingq.com/api/v2/ja/lessons/"
    val key = PropertyReader.getProperty("me.avo.kumo.lingq.key")
    ...
    fun getLessons(language: String, collection: Int) = getClient().use {
        val finalUrl = "https://www.me.avo.kumo.lingq.com/api/languages/$language/course/?course=$collection" // alternate
